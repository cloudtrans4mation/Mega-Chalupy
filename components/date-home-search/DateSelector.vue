...
const emitSelectedDates = () => {
  ...
  console.log('Emitting dates:', dates);
...
<template>
  <div class="flex flex-col gap-2">
    <Label class="text-sm text-blue11" for="date-field">
      Check-in -- Check-out
    </Label>
    <DateRangePickerRoot
      id="date-field"
                ...
                >
                  ...
                  >
                    <DateRangePickerCellTrigger
                      :day="weekDate"
                      :month="month.value"
                      class="relative flex items-center justify-center rounded-full whitespace-nowrap text-sm font-normal text-black w-8 h-8 outline-none focus:shadow-[0_0_0_2px] focus:shadow-black data-[disabled]:text-black/30 data-[selected]:!bg-blue-500 data-[selected]:text-white hover:bg-blue-100 data-[highlighted]:bg-blue-100 data-[unavailable]:pointer-events-none data-[unavailable]:text-black/30 data-[unavailable]:line-through before:absolute before:top-[5px] before:hidden before:rounded-full before:w-1 before:h-1 before:bg-white data-[today]:before:block data-[today]:before:bg-blue-300"
                    />
                  </DateRangePickerCell>
                </DateRangePickerGridRow>
              </DateRangePickerGridBody>
