<template>
  <div class="relative flex justify-center items-center w-full max-w-screen-xl mx-auto overflow-hidden py-8 bg-gradient-to-r from-purple-400 via-pink-500 to-red-500">
    <!-- Previous Button -->
    <button @click="prevSlide" class="absolute left-4 md:left-8 bg-white text-gray-800 p-3 rounded-full shadow-lg z-10 hover:bg-gray-100 transition duration-300">
    ...
    <div class="flex transition-transform duration-500 ease-in-out" :style="{ transform: `translateX(-${currentIndex * 100}%)` }">
      ...
      >
        ...
        <div class="text-center text-white bg-black bg-opacity-50 p-6 rounded-lg shadow-lg backdrop-blur-md">
          ...
          <button class="mt-4 px-8 py-4 bg-blue-600 text-white font-semibold rounded-full hover:bg-blue-700 transition duration-300 shadow-lg">
            See More
          </button>
        </div>
      </div>
    ...
    <!-- Next Button -->
    <button @click="nextSlide" class="absolute right-4 md:right-8 bg-white text-gray-800 p-3 rounded-full shadow-lg z-10 hover:bg-gray-100 transition duration-300">
